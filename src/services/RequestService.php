...
class RequestService
{
    ...
    private function consult($wsdlSuffix, $xml, $method, $return){
        ...
        $dom = new \DOMDocument();        
        $dom->loadXML($xml);        
        $dom->save('C:\Users\Usuario\Downloads\XML_Envio.xml');
        //dd($xml);
        try{
    ...
    public function consultarSituacaoLoteRps($xml)
    {
        ...
        */
        ...
        $dom = new \DOMDocument();        
        $dom->loadXML($xml);        
        $dom->save('C:\Users\Usuario\Downloads\XML_Consulta_situacao.xml');
        try{
    ...
    public function consultarLoteRps($xml)
    {
        ...
        */
        ...
        $dom = new \DOMDocument();        
        $dom->loadXML($xml);        
        $dom->save('C:\Users\Usuario\Downloads\XML_Consulta.xml');
        try{
            //executando a funcao ConsultarLoteRpsV3 do webservice
        ...
        if(isset($xmlObj->ListaMensagemRetorno)){                        
            ...
            $xmlObj = new \DOMDocument();
            $xmlObj->loadXML($result);                
            $xmlObj->save('C:\Users\Usuario\Downloads\XML_Resposta.xml');
    ...
    public function cancelarNFSe($xml)
    {
        ...
        */
        ...
        $dom = new \DOMDocument();        
        $dom->loadXML($xml);        
        $dom->save('C:\Users\Usuario\Downloads\XML_Cancelamento.xml');
        try{
            //executando a funcao ConsultarLoteRpsV3 do webservice
